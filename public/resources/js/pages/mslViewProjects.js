var MSLViewProjects = function (containerId) {

    this.container = $('#' + containerId);
    this.id = UUID();

};
MSLViewProjects.prototype = {
        ...
        $.ajax({
            ...
            context: document.body
             ...
             if (response && response['type'] === 'SUCCESS') {
                 ...
                 var projectsList = new MSLProjectsList('msl-projects-components',response['data']);
                 projectsList.init();
...
$(document).ready(function(){
	...
	var projects = new MSLViewProjects('msl-projects-content');
	projects.init(); 
