var MSLProjectsList = function (containerId,data) {
...
MSLProjectsList.prototype = {
    ...
    _viewPlansAction : function(id){
        ...
        $.ajax({
            ...
            if (response && response['type'] === 'SUCCESS') {
            	$('#proj-list-view').hide();
                var planViewer = new MSLPlanViewer(id,'proj-item-view','proj-list-view',response['data']['plans']);
                planViewer.init();
                $('#proj-item-view').show();
