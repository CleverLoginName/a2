 ...
 *
 */
var LMUser = function (containerId) {
...
LMUser.prototype = {
    ...
    init: function () {
        ...
        window.breadcrumb.addItem("Merchant", this.container.attr('id'));
    ...
    _initUI: function () {
        ...
        var uiTemplate = '<form class="row new-item-from-wrapper" role="form" method="post" id="new-user-form">' +
            ...
            '<section class="row form-group">' +
            '<section class="col-md-2"></section>' +
            '<section class="col-md-2"><label>Merchant Type</label></section>' +
            '<section class="col-md-6">' +
            
            '<select class="form-control required notselected" id="usr-frm-type" name="usr-frm-type">' +
            '<option value="default">Select Merchant Type</option>' +
    ...
    _submitData : function(data){
        ...
        $.ajax({
            ...
            alertify.error("Failed to create Merchant due to System Fault.");
            $('#' + _this.id + '-new-user-loading').hide();
            $('#' + _this.id + '-new-user-btn').attr('disabled',false);
        });
