var LMEditList = function (containerId,data) {
...
LMEditList.prototype = {
    ...
    _removeAction : function(id,cid){
        ...
        var _this = this;
        $.ajax({
            url: "restAPI/user/lm/" + id + "/cid/" + cid + "/remove",
            context: document.body
        }).done(function (response) {
    ...
    _enableAction : function(id,cid){
    	...
    	$.ajax({
            url: "restAPI/user/lm/" + id + "/cid/" + cid + "/enable",
            context: document.body
        }).done(function (response) {
    ...
    _disableAction : function(id,cid){
    	...
    	$.ajax({
            url: "restAPI/user/lm/" + id + "/cid/" + cid + "/disable",
            context: document.body
        }).done(function (response) {
