 ...
 *
 */
var ASAUser = function (containerId) {
...
ASAUser.prototype = {
    ...
    init: function () {
        ...
        window.breadcrumb.addItem("Adopto System Administrator", this.container.attr('id'));
    ...
    _submitData : function(data){
        ...
        $.ajax({
            ...
            alertify.error("Failed to create Adopto System Administrator due to System Fault.");
            $('#' + _this.id + '-new-user-loading').hide();
            $('#' + _this.id + '-new-user-btn').attr('disabled',false);
        });
