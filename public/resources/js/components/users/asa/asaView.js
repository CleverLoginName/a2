var ASAView = function (containerId,data,returningId) {
...
ASAView.prototype = {
    ...
    _initUI: function () {
        ...
        var uiTemplate = '<form class="row new-item-from-wrapper">' +
            ...
            '<label><input type="checkbox" id="usr-frm-subs-product" onclick="return false">Products</label>' +
            '<label><input type="checkbox" id="usr-frm-subs-project" onclick="return false">Projects</label>' +
            '</section>' +
            '<section class="col-md-2"></section>' +
            '</section>' +*/
