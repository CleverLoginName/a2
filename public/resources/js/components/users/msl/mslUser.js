 ...
 *
 */
var MSLUser = function (containerId) {
...
MSLUser.prototype = {
    ...
    init: function () {
        ...
        window.breadcrumb.addItem("Master Software Licensee", this.container.attr('id'));
    ...
    _submitData : function(data){
        ...
        $.ajax({
            ...
            alertify.error("Failed to create Master Software Licensee due to System Fault.");
            $('#' + _this.id + '-new-user-loading').hide();
            $('#' + _this.id + '-new-user-btn').attr('disabled',false);
        });
