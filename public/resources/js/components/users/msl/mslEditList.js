var MSLEditList = function (containerId,data) {
...
MSLEditList.prototype = {
    ...
    _removeAction : function(id,cid){
        ...
        var _this = this;
        $.ajax({
            url: "restAPI/user/msl/" + id + "/cid/" + cid + "/remove",
            context: document.body
        }).done(function (response) {
    ...
    _enableAction : function(id,cid){
    	...
    	$.ajax({
            url: "restAPI/user/msl/" + id + "/cid/" + cid + "/enable",
            context: document.body
        }).done(function (response) {
    ...
    _disableAction : function(id,cid){
    	...
    	$.ajax({
            url: "restAPI/user/msl/" + id + "/cid/" + cid + "/disable",
            context: document.body
        }).done(function (response) {
