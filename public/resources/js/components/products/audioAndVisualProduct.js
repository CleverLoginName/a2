var AudioAndVisualProduct = function (containerId,initData) {
...
AudioAndVisualProduct.prototype = {
    ...
    init: function () {
        ...
        window.breadcrumb.addItem("Audio And Visual", this.container.attr('id'));
