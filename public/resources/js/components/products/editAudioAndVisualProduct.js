var EditAudioAndVisualProduct = function (containerId,data,returningId,initData) {
...
EditAudioAndVisualProduct.prototype = {
    ...
    _initUI: function () {
        ...
        var uiTemplate = '<form class="row new-item-from-wrapper" role="form"  method="post" id="edit-prod-form" enctype="multipart/form-data">' +
            ...
            '<section class="col-md-6"><input type="text" class="form-control required" id="prod-frm-elev" name="prod-frm-elev" value="' + this.data['elevation'] + '"/></section>' +
            '<section class="col-md-2"></section>' +
            '</section>' +
    ...
    _submitData : function(data){
        ...
        $.ajax({
            type: 'POST',
            url: 'restAPI/product/av/' + _this.data['id'] + '/update',
            data: data,
            processData: false,
            contentType: false,
            cache:false
