var InteriorDesignProduct = function (containerId,initData) {
...
InteriorDesignProduct.prototype = {
    ...
    init: function () {
        ...
        window.breadcrumb.addItem("Interior Design", this.container.attr('id'));
