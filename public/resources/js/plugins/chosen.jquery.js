    ...
    Plugin.prototype = {
        ...
        _selectIndex: function(index) {
            ...
            if (this.settings.showSelectionTextOnly) {
                ...
                this.ddSelection.html((optionData.imageSrc ? '<img src="' + optionData.imageSrc + '" />' : '') +
                                      ...
                                      (optionData.description ? '<small>' + optionData.description + '</small>' : '') + '<span class="ddListArrow"></span>');
            }
        },
        ...
        _enable: function () {
            ...
            this.ddSelection.on('click.ddlist', function () {
            	var isOpened = $(this).attr("data-is-open");
            	if(isOpened == "false"){
                    self._open();
            ...
            this.ddOptions.find('a').on('click.ddlist', function () {
            	...
            	self.ddSelection.attr("data-is-open",false);
                // Select (new) index
        ...
        _init: function (options) {
            ...
            this.ddListObj = $('<div id="ddList-' + this.selObj.attr('id') + '" class="ddListContainer"><a data-is-open="false"></a><ul></ul></div>');
            ...
            this.ddOptions.css({ 'height' : this.settings.minHeight });
