...
function getOffsetRect(e) {
    var t = e.getBoundingClientRect(),
        ...
        a = window.pageYOffset || i.scrollTop || s.scrollTop,
        n = window.pageXOffset || i.scrollLeft || s.scrollLeft,
        r = i.clientTop || s.clientTop || 0,
        d = i.clientLeft || s.clientLeft || 0,
        o = t.top + a - r,
        l = t.left + n - d;
    return {
        top: Math.round(o),
...
function dhtmlXHeir(e, t) {
    for (var s in t) "function" == typeof t[s] && (e[s] = t[s]);
    return e
}
...
window.dhtmlXScheduler = window.scheduler = {
        ...
        if (this.xmlDoc.responseXML) {
            ...
            if (0 === i.length && -1 != e.indexOf(":")) var i = this.xmlDoc.responseXML.getElementsByTagName(e.split(":")[1]);
            s = i[0]
        } else s = this.xmlDoc.documentElement;
        if (s) return this._retry = !1, s;
        ...
        if (window.name) {
            ...
            if (parent.dhtmlDragAndDrop) {
                ...
                s += 1 * a.split("_")[0], i += 1 * a.split("_")[1]
            }
            if (e) return s + "_" + i;
            this.fx = s, this.fy = i
        }
        ...
        if (_isIE) return t || (t = this.xmlDoc.nodeName ? this.xmlDoc : this.xmlDoc.responseXML), t || dhtmlxError.throwError("LoadXML", "Incorrect XML", [t || this.xmlDoc, this.mainObject]), s && t.setProperty("SelectionNamespaces", "xmlns:xsl='" + s + "'"), "single" == i ? t.selectSingleNode(e) : t.selectNodes(e) || new Array(0);
        var a = t;
        ...
        "single" == i && (n = XPathResult.FIRST_ORDERED_NODE_TYPE);
        var r = [],
        ...
        if ("." == s[0]) i = [t];
            ...
            if ("" !== s[0]) return [];
            i = (this.xmlDoc.responseXML || this.xmlDoc).getElementsByTagName(s[a].replace(/\[[^\]]*\]/g, "")), a++
        }
        for (a; a < s.length; a++) i = this._getAllNamedChilds(i, s[a]);
        return -1 != s[a - 1].indexOf("[") && (i = this._filterXPath(i, s[a - 1])), i
        ...
        for (var i = 0; i < e.length; i++)
            for (var a = 0; a < e[i].childNodes.length; a++) _isKHTML ? e[i].childNodes[a].tagName && e[i].childNodes[a].tagName.toUpperCase() == t && (s[s.length] = e[i].childNodes[a]) : e[i].childNodes[a].tagName == t && (s[s.length] = e[i].childNodes[a]);
        return s
    }, "undefined" == typeof window.dhtmlxEvent && (window.dhtmlxEvent = function(e, t, s) {
        ...
        } else this.XSLProcessor || (this.XSLProcessor = new XSLTProcessor, this.XSLProcessor.importStylesheet(e)), s = this.XSLProcessor.transformToDocument(t);
        return s
    ...
    function() {
        ...
        function i(e, t, s) {
            var i = s ? s : e || "",
                a = "dhtmlx_" + i.toLowerCase().replace(/ /g, "_") + "_button";
        ...
        function n(t, s, a) {
            ...
            var r = "";
            if (t.width && (n.style.width = t.width), t.height && (n.style.height = t.height), t.title && (r += '<div class="dhtmlx_popup_title">' + t.title + "</div>"), r += '<div class="dhtmlx_popup_text"><span>' + (t.content ? "" : t.text) + '</span></div><div  class="dhtmlx_popup_controls">', s) {
            ...
            if (t.buttons)
                for (var l = 0; l < t.buttons.length; l++) r += i(t.buttons[l], l);
        ...
        setUpdated: function(e, t, s) {
            if (!this._silent_mode) {
                ...
                a && "updated" == s && (s = a), t ? (this.set_invalid(e, !1), this.updatedRows[i] = e, this.obj.setUserData(e, this.action_param, s), this._in_progress[e] && (this._in_progress[e] = "wait")) : this.is_invalid(e) || (this.updatedRows.splice(i, 1), this.obj.setUserData(e, this.action_param, "")), t || this._clearUpdateFlag(e), this.markRow(e, t, s), t && this.autoUpdate && this.sendData(e)
            }
        },
        ...
        markRow: function(e, t, s) {
            var i = "",
                a = this.is_invalid(e);
            if (a && (i = this.styles[a], t = !0), this.callEvent("onRowMark", [e, t, s, a]) && (i = this.styles[t ? s : "clear"] + i, this.obj[this._methods[0]](e, i), a && a.details)) {
                i += this.styles[a + "_cell"];
                for (var n = 0; n < a.details.length; n++) a.details[n] && this.obj[this._methods[1]](e, n, i)
            }
        },
        getState: function(e) {
        ...
        serialize: function(e, t) {
            ...
            var s = [],
                i = [];
            for (var a in e) e.hasOwnProperty(a) && (s.push(this.serialize_one(e[a], a + this.post_delim)), i.push(a));
        ...
        serialize_one: function(e, t) {
            ...
            for (var i in e)
                if (e.hasOwnProperty(i)) {
                    ...
                    s.push(this.escape((t || "") + i) + "=" + this.escape(e[i]))
                }
            return s.join("&")
        },
        _sendData: function(e, t) {
            if (e) {
                ...
                var s = new dtmlXMLLoaderObject(function(s, i, a, n, r) {
                        var d = [];
                        if (t) d.push(t);
                        else if (e)
                            for (var o in e) d.push(o);
                        return s.afterUpdate(s, r, d)
                    }, this, !0),
                ...
                if ("GET" == this._tMode) s.loadXML(i + (-1 != i.indexOf("?") ? "&" : "?") + this.serialize(e, t));
                else if ("POST" == this._tMode) s.loadXML(i, !0, this.serialize(e, t));
                else if ("REST" == this._tMode) {
                    var a = this.getState(t),
                        n = i.replace(/(\&|\?)editing\=true/, "");
                    "inserted" == a ? s.loadXML(n + t, "POST", this.serialize(e, t)) : "deleted" == a ? s.loadXML(n + t, "DELETE", "") : s.loadXML(n + t, "PUT", this.serialize(e, t))
                }
                this._waitMode++
            }
        },
        ...
        _getAllData: function() {
            for (var e = {}, t = !1, s = 0; s < this.updatedRows.length; s++) {
                ...
                this._in_progress[i] || this.is_invalid(i) || this.callEvent("onBeforeUpdate", [i, this.getState(i), this._getRowData(i)]) && (e[i] = this._getRowData(i, i + this.post_delim), t = !0, this._in_progress[i] = (new Date).valueOf())
            }
            return t ? e : null
        },
        ...
        afterUpdateCallback: function(e, t, s, i) {
            var a = e,
                n = "error" != s && "invalid" != s;
            if (n || this.set_invalid(e, s), this._uActions && this._uActions[s] && !this._uActions[s](i)) return delete this._in_progress[a];
            ...
            switch (s) {
                ...
                case "delete":
                case "deleted":
                    return this.obj.setUserData(e, this.action_param, "true_deleted"), this.obj[this._methods[3]](e), delete this._in_progress[a], this.callEvent("onAfterUpdate", [e, s, t, i])
            }
            "wait" != this._in_progress[a] ? (n && this.obj.setUserData(e, this.action_param, ""), delete this._in_progress[a]) : (delete this._in_progress[a], this.setUpdated(t, !0, this.obj.getUserData(e, this.action_param))), this.callEvent("onAfterUpdate", [r, s, t, i])
        },
        afterUpdate: function(e, t, s) {
            if (window.JSON) try {
                var i = JSON.parse(t.xmlDoc.responseText),
                    a = i.action || this.getState(s) || "updated",
                    n = i.sid || s[0],
                    r = i.tid || s[0];
                return e.afterUpdateCallback(n, r, a, i), void e.finalizeUpdate()
            } catch (d) {}
            if (t.getXMLTopNode("data"), !t.xmlDoc.responseXML) return this.obj && this.obj.callEvent && this.obj.callEvent("onSaveError", [s, t.xmlDoc]), this.cleanUpdate(s);
            var o = t.doXPath("//data/action");
            if (!o.length) return this.cleanUpdate(s);
        ...
        _a: function(e) {
            for (var t = [], s = 0; s < e.length; s++) t[s] = this._v(e[s]);
            return t
        },
        loadUpdate: function() {
            var e = this,
                t = this.obj.getUserData(0, "version"),
                s = this.serverProcessor + getUrlSymbol(this.serverProcessor) + ["dhx_user=" + this._user, "dhx_version=" + t].join("&");
            s = s.replace("editing=true&", ""), this.getUpdates(s, function() {
                ...
                if (s.length) {
                    ...
                    for (var i = 0; i < s.length; i++) {
                        var a = s[i].getAttribute("status"),
                            n = s[i].getAttribute("id"),
                            r = s[i].getAttribute("parent");
                        switch (a) {
                            case "inserted":
                                e.callEvent("insertCallback", [s[i], n, r]);
                                break;
                            case "updated":
                                e.callEvent("updateCallback", [s[i], n, r]);
                                break;
                            case "deleted":
                                e.callEvent("deleteCallback", [s[i], n, r])
                        }
                    }
                    e._silent_mode = !1
                }
        ...
        var e = this._x = this._obj.clientWidth - this.xy.margin_left,
            ...
            s = this._table_view ? 0 : this.xy.scale_width + this.xy.scroll_width,
    ...
    }, scheduler.set_xy = function(e, t, s, i, a) {
        e.style.width = Math.max(0, t) + "px", e.style.height = Math.max(0, s) + "px", arguments.length > 3 && (e.style.left = i + "px", e.style.top = a + "px")
        ...
        for (var e = this._obj.getElementsByTagName("DIV"), t = 0; t < e.length; t++) {
            ...
            var a = scheduler.locale.labels[i || s];
            "string" != typeof a && i && !e[t].innerHTML && (a = i.split("_")[0]), a && (e[t].innerHTML = a)
        }
        ...
        this._obj.onselectstart = function() {
            ...
            var t = e || event,
                ...
                i = scheduler.callEvent("onContextMenu", [scheduler._locate_event(s), t]);
            return i
        }
        ...
        dhx_cal_data: function(e) {
            ...
            var t = e ? e.target : event.srcElement,
                s = scheduler._locate_event(t);
            if (e = e || event, s) {
                if (!scheduler.callEvent("onClick", [s, e]) || scheduler.config.readonly) return
            } else scheduler.callEvent("onEmptyClick", [scheduler.getActionData(e).date, e]);
            if (s && scheduler.config.select) {
                scheduler.select(s);
                var i = t.className; - 1 != i.indexOf("_icon") && scheduler._click.buttons[i.split(" ")[1].replace("icon_", "")](s)
        ...
        e || (e = i.start_date || Math.round(scheduler._currentDate().valueOf() / a) * a);
        var n = new Date(e);
        if (!t) {
        ...
        var d = new Date(t);
        n.valueOf() == d.valueOf() && d.setTime(d.valueOf() + a), i.start_date = i.start_date || n, i.end_date = i.end_date || d, i.text = i.text || this.locale.labels.new_event, i.id = this._drag_id = this.uid(), this._drag_mode = "new-size", this._loading = !0, this.addEvent(i), this.callEvent("onEventCreated", [this._drag_id, s]), this._loading = !1, this._drag_event = {}, this._on_mouse_up(s)
        ...
        if (t = t || e.target || e.srcElement, !this.config.readonly) {
            ...
            switch (s) {
                ...
                case "dhx_cal_event_clear":
                    ...
                    if (!this.callEvent("onDblClick", [i, e])) return;
        ...
        var t = 0;
        if (this._cols) {
            for (var s = 0, i = 0; i < this._cols.length && !s; i++) s = this._cols[i];
            if (t = s ? e / s : 0, this._ignores)
                for (var i = 0; t >= i; i++) this._ignores[i] && t++
        }
        return t
        ...
        var i = 100,
            a = 5;
        return !!(!this._drag_pos.start || +new Date - this._drag_pos.start > i || s(e.x, t.x, a) || s(e.y, t.y, a))
        ...
        if (this._drag_mode) {
            ...
            if (t.force_redraw || this._is_pos_changed(this._drag_pos, t)) {
                ...
                if ("move" == this._drag_mode) s = this._min_date.valueOf() + 6e4 * (t.y * this.config.time_step + 24 * t.x * 60 - (scheduler._move_pos_shift || 0)), !t.custom && this._table_view && (s += 1e3 * this.date.time_part(o.start_date)), s = this._correct_shift(s), t._ignores && this.config.preserve_length && this._table_view ? (this.matrix && (d = this.matrix[this._mode]), d = d || {
                    x_step: 1,
                    x_unit: "day"
                    ...
                    if (s = o.start_date.valueOf(), i = o.end_date.valueOf(), this._table_view) {
                        ...
                        else t.resize_from_start ? s = l : i = l
                    } else i = this.date.date_part(new Date(o.end_date.valueOf() - 1)).valueOf() + t.y * this.config.time_step * 6e4, this._els.dhx_cal_data[0].style.cursor = "s-resize", ("week" == this._mode || "day" == this._mode) && (i = this._correct_shift(i));
                    if ("new-size" == this._drag_mode)
                        ...
                        } else s = this._drag_start;
                    else s >= i && (i = s + 6e4 * this.config.time_step)
                }
                var c = new Date(i - 1),
                    u = new Date(s);
                ...
                if (!this._table_view && !scheduler.config.all_timed && (!scheduler._get_section_view() && t.x != this._get_event_sday({
                    ...
                    i = scheduler.date.date_part(new Date(h)), i.setHours(this.config.last_hour), c = new Date(i - 1), "move" == this._drag_mode && (u = new Date(+i - g))
                }
        ...
        if (2 != e.button && !this.config.readonly && !this._drag_mode) {
            ...
            switch (s) {
                ...
                case "":
                    ...
                    break;
                default:
                    if ((!scheduler.checkEvent("onMouseDown") || scheduler.callEvent("onMouseDown", [s])) && t.parentNode && t != this && "dhx_body" != s) return scheduler._on_mouse_down(e, t.parentNode);
                    this._drag_mode = null, this._drag_id = null
            }
            if (this._drag_mode) {
                var i = this._locate_event(t);
                this.config["drag_" + this._drag_mode] && this.callEvent("onBeforeDrag", [i, this._drag_mode, e]) ? (this._drag_id = i, this._drag_event = scheduler._lame_clone(this.getEvent(this._drag_id) || {}), this._drag_pos = this._mouse_coords(e), this._drag_pos.start = +new Date) : this._drag_mode = this._drag_id = 0
            }
            this._drag_start = null
        }
    }, scheduler._get_private_properties = function(e) {
        var t = {};
        for (var s in e) 0 === s.indexOf("_") && (t[s] = !0);
        return t
    }, scheduler._clear_temporary_properties = function(e, t) {
        var s = this._get_private_properties(e),
            i = this._get_private_properties(t);
        for (var a in i) s[a] || delete t[a]
        ...
        if (!e || 2 != e.button || !scheduler.config.touch) {
            if (this._drag_mode && this._drag_id) {
                ...
                if (this._drag_event._dhx_changed || !this._drag_event.start_date || i.start_date.valueOf() != this._drag_event.start_date.valueOf() || i.end_date.valueOf() != this._drag_event.end_date.valueOf()) {
                    ...
                    if (this.callEvent("onBeforeEventChanged", [i, e, a, this._drag_event]))
                    ...
                    else a ? this.deleteEvent(i.id, !0) : (this._drag_event._dhx_changed = !1, this._clear_temporary_properties(i, this._drag_event), scheduler._lame_copy(i, this._drag_event), this.updateEvent(i.id))
                }
    ...
    }, scheduler._render_x_header = function(e, t, s, i, a) {
        a = a || 0;
        var n = document.createElement("DIV");
        ...
        "month" == this._mode && 0 === e && this.config.left_border && (n.className += " dhx_scale_bar_border", t += 1), this.set_xy(n, r, this.xy.scale_height - 2, t, a), n.innerHTML = this.templates[this._mode + "_scale_date"](s, this._mode), i.appendChild(n)
        ...
        var i = e,
            a = this._get_columns_num(t, s);
        this._process_ignores(t, a, "day", 1);
        for (var n = a - this._ignores_detected, r = 0; a > r; r++) this._ignores[r] ? (this._cols[r] = 0, n++) : this._cols[r] = Math.floor(i / (n - r)), i -= this._cols[r], this._colsS[r] = (this._cols[r - 1] || 0) + (this._colsS[r - 1] || (this._table_view ? 0 : this.xy.scale_width + 2));
        ...
        var s = new Date(scheduler._min_date),
            i = new Date(scheduler._max_date),
            a = this.date.date_part(scheduler._currentDate()),
            n = parseInt(e.style.width, 10),
            r = new Date(this._min_date),
            d = this._get_columns_num(s, i);
        this._calc_scale_sizes(n, s, i);
        var o = 0;
        e.innerHTML = "";
        for (var l = 0; d > l; l++) {
        ...
        for (var s = new Date(1980, 1, 1, this.config.first_hour, 0, 0), i = 1 * this.config.first_hour; i < this.config.last_hour; i++) {
            ...
            this.config.left_border && (n -= 1, a.className += " dhx_scale_hour_border"), a.style.width = n + "px", a.innerHTML = scheduler.templates.hour_scale(s), t.appendChild(a), s = this.date.add(s, 1, "hour")
        }
    ...
    }, scheduler._process_ignores = function(e, t, s, i, a) {
        this._ignores = {}, this._ignores_detected = 0;
        var n = scheduler["ignore_" + this._mode];
        if (n)
            for (var r = new Date(e), d = 0; t > d; d++) n(r) && (this._ignores_detected += 1, this._ignores[d] = !0, a && t++), r = scheduler.date.add(r, i, s), scheduler.date[s + "_start"] && (r = scheduler.date[s + "_start"](r))
        ...
        for (var d = Math.ceil(Math.round((a.valueOf() - s.valueOf()) / 864e5) / 7), o = [], l = 0; 7 >= l; l++) {
        ...
        for (var _ = 0, c = "<table cellpadding='0' cellspacing='0'>", u = [], l = 0; d > l; l++) {
            c += "<tr>";
            for (var g = Math.max(i(l) - scheduler.xy.month_head_height, 0), f = 0; 7 > f; f++) {
                c += "<td";
                var v = "";
                t > s ? v = "dhx_before" : s >= a ? v = "dhx_after" : s.valueOf() == r.valueOf() && (v = "dhx_now"), this._ignores_detected && this._ignores[f] && (v += " dhx_scale_ignore"), c += " class='" + v + " " + this.templates.month_date_class(s, r) + "' >";
                var m = "dhx_month_body",
                    p = "dhx_month_head";
                0 === f && this.config.left_border && (m += " dhx_month_body_border", p += " dhx_month_head_border"), this._ignores_detected && this._ignores[f] ? c += "<div></div><div></div>" : (c += "<div class='" + p + "'>" + this.templates.month_day(s) + "</div>", c += "<div class='" + m + "' " + o[f] + ";height:" + g + "px;'></div></td>"), u.push(s);
                var x = s.getDate();
        ...
        c += "</table>", this._min_date = n, this._max_date = s, e.innerHTML = c, this._scales = {};
        ...
        var i = scheduler.date.add(t, 1, "month"),
            a = scheduler._currentDate();
        this.date.date_part(a), this.date.date_part(s);
        var n = Math.ceil(Math.round((i.valueOf() - s.valueOf()) / 864e5) / 7),
        ...
        for (var s = this.config.lightbox.sections, i = 0; i < s.length; i++)
            if (s[i].map_to == e)
                for (var a = s[i].options, n = 0; n < a.length; n++)
        ...
        if (e && "object" == typeof e) {
            for (a = {}, i = [Array, Date, Number, String, Boolean], s = 0; s < i.length; s++) e instanceof i[s] && (a = s ? new i[s](e) : new i[s]);
            t.push(e, a);
            for (s in e) Object.prototype.hasOwnProperty.apply(e, [s]) && (a[s] = scheduler._lame_clone(e[s], t))
        }
        return a || e
        ...
        var i, a = t - e,
            n = s._start_correction + s._end_correction || 0,
            r = this["ignore_" + this._mode],
            d = 0;
        for (s.render ? (d = this._get_date_index(s, e), i = this._get_date_index(s, t)) : i = Math.round(a / 60 / 60 / 1e3 / 24); i > d;) {
        ...
        if (s._start_correction || s._end_correction) {
            var r;
            r = i ? 60 * a.getHours() + a.getMinutes() - 60 * (s.first_hour || 0) : 60 * (s.last_hour || 0) - (60 * a.getHours() + a.getMinutes());
            var d = 60 * (s.last_hour - s.first_hour),
        ...
        var l, h = new Date(1 * e + t * n),
            ...
            c = 0;
        for (s.render ? (c = this._get_date_index(s, a), l = this._get_date_index(s, h)) : l = Math.round(t / 60 / 60 / 1e3 / 24); l * n >= c * n;) {
            var u = scheduler.date.add(a, s.x_step * n, s.x_unit);
        ...
        init: function() {
            for (var e = scheduler.locale.date.month_short, t = scheduler.locale.date.month_short_hash = {}, s = 0; s < e.length; s++) t[e[s]] = s;
            for (var e = scheduler.locale.date.month_full, t = scheduler.locale.date.month_full_hash = {}, s = 0; s < e.length; s++) t[e[s]] = s
        },
        ...
        _add_days: function(e, t) {
            ...
            return s.setDate(s.getDate() + t), !e.getHours() && s.getHours() && (s.getDate() < e.getDate() || s.getMonth() < e.getMonth() || s.getFullYear() < e.getFullYear()) && s.setTime(s.getTime() + 36e5 * (24 - s.getHours())), s
        },
        add: function(e, t, s) {
        ...
        str_to_date: function(e, t) {
            for (var s = "var temp=date.match(/[a-zA-Z]+|[0-9]+/g);", i = e.match(/%[a-zA-Z]/g), a = 0; a < i.length; a++) switch (i[a]) {
                ...
                case "%m":
                    ...
                    break;
                case "%y":
                    s += "set[0]=temp[" + a + "]*1+(temp[" + a + "]>50?1900:2000);";
                    break;
                case "%g":
                case "%G":
                case "%h":
                ...
                case "%a":
                case "%A":
                    s += "set[3]=set[3]%12+((temp[" + a + "]||'').toLowerCase()=='am'?0:12);";
                    break;
                case "%s":
                    s += "set[5]=temp[" + a + "]||0;";
                    break;
                case "%M":
                    s += "set[1]=scheduler.locale.date.month_short_hash[temp[" + a + "]]||0;";
                    break;
                case "%F":
                    s += "set[1]=scheduler.locale.date.month_full_hash[temp[" + a + "]]||0;"
            }
            var n = "set[0],set[1],set[2],set[3],set[4],set[5]";
            return t && (n = " Date.UTC(" + n + ")"), new Function("date", "var set=[0,0,1,0,0,0]; " + s + " return new Date(" + n + ");")
        },
        getISOWeek: function(e) {
            ...
            var i = s.getFullYear(),
                a = Math.round((s.getTime() - new Date(i, 0, 1).getTime()) / 864e5),
                n = 1 + Math.floor(a / 7);
            return n
        },
    ...
    }, scheduler.addEvent = function(e, t, s, i, a) {
        if (!arguments.length) return this.addEventNow();
        var n = e;
        1 != arguments.length && (n = a || {}, n.start_date = e, n.end_date = t, n.text = s, n.id = i), n.id = n.id || scheduler.uid(), n.text = n.text || "", "string" == typeof n.start_date && (n.start_date = this.templates.api_date(n.start_date)), "string" == typeof n.end_date && (n.end_date = this.templates.api_date(n.end_date));
        ...
        for (var s = this._rendered.length - 1; s >= 0; s--) this._rendered[s].getAttribute("event_id") == e && t(this._rendered[s], s)
    ...
    function() {
        for (var e = ["text", "Text", "start_date", "StartDate", "end_date", "EndDate"], t = function(e) {
            ...
            }, i = 0; i < e.length; i += 2) scheduler["getEvent" + e[i + 1]] = t(e[i]), scheduler["setEvent" + e[i + 1]] = s(e[i])
        ...
        if (t) {
            var s = this._table_view || e.end_date.getHours() >= this.config.first_hour && e.end_date.getHours() < this.config.last_hour || e.start_date.getHours() >= this.config.first_hour && e.start_date.getHours() < this.config.last_hour;
            if (s) return !0;
            var i = (e.end_date.valueOf() - e.start_date.valueOf()) / 36e5,
        ...
        var t = [];
        for (var s in this._events) this.is_visible_events(this._events[s]) && (!e || this._events[s]._timed) && this.filter_event(s, this._events[s]) && t.push(this._events[s]);
        return t
        ...
        for (var s = 0, i = e.length; i > s; s++) this._recalculate_timed(e[s]);
        ...
        for (var t = this._rendered_location, s = this._lame_clone(e), i = e._sday; i < e._eday; i++) {
            ...
            n = a.add(n, s._sweek, "week"), n = a.add(n, s._sday, "day");
            var r = scheduler.getEvents(n, a.add(n, 1, "day")).length,
                d = this._get_event_bar_pos(s),
                o = d.x2 - d.x,
        ...
        for (var s = 0; s < e.length; s++)
            if (this._table_view)
                if ("month" != scheduler._mode) this.render_event_bar(e[s]);
                else {
            ...
            if (t) this._colsS.heights = i;
                ...
                if (r.rows) {
                    for (var d = 0; d < r.rows.length; d++) {
                        ...
                        if (a[d] * s > l) {
                            var h = l;
                            1 * this.config.max_month_events !== this.config.max_month_events || a[d] <= this.config.max_month_events ? h = a[d] * s : (this.config.max_month_events + 1) * s > l && (h = (this.config.max_month_events + 1) * s);
                    ...
                    var f = (r.parentNode.childNodes, (a[0] + 1) * s + 1),
                        v = f,
                        m = f + "px";
                    ...
                    x.style.height = m, x.style.visibility = -1 == a[0] ? "hidden" : "visible", x.className = a[0] ? "dhx_multi_day_icon" : "dhx_multi_day_icon_small", this._dy_shift = (a[0] + 1) * s, this.config.multi_day_height_limit && (this._dy_shift = Math.min(this.config.multi_day_height_limit, this._dy_shift)), a[0] = 0, v != f && (n.style.top = parseInt(n.style.top) + 2 + "px", p.style.overflowY = "auto", x.style.position = "fixed", x.style.top = "", x.style.left = "")
                }
            }
        return e
        ...
        if (!t) {
            for (var a = 0; a < e.length; a++) e[a]._count = s[e[a]._sday].max_count;
            for (var a = 0; a < i.length; a++) i[a]._count = s[i[a]._sday].max_count
        }
        return e
        ...
        for (var s, i = [], a = [
            ...
            if (l._sday = g % r, !this._ignores[l._sday] || !l._timed) {
                ...
                if (l._sorder && t || (l._sorder = v), l._sday + l._length <= r) s = null, i.push(l), m[v] = l, n[l._sweek] = m.length - 1, l._first_chunk = _.first_chunk, l._last_chunk = _.last_chunk;
                else {
        ...
        t = t || 0;
        var s = 60 * e.start_date.getHours() + e.start_date.getMinutes(),
            i = 60 * e.end_date.getHours() + e.end_date.getMinutes() || 60 * scheduler.config.last_hour,
            a = this._y_from_date(e.start_date),
            n = Math.max(t, (i - s) * this.config.hour_size_px / 60);
        return {
            top: a,
            height: n
        }
        ...
        var t = scheduler.xy.menu_width,
            s = this.config.use_select_menu_space ? 0 : t;
        if (!(e._sday < 0)) {
            ...
            if (i) {
                var a = this._calc_event_y(e, scheduler.xy.min_event_height),
                    ...
                    d = e._count || 1,
                    o = e._sorder || 0,
                    l = Math.floor((i.clientWidth - s) / d),
                    h = o * l + 1;
                ...
                var g = this._render_v_bar(e, s + h, n, l, r, e._text_style, scheduler.templates.event_header(e.start_date, e.end_date, e), scheduler.templates.event_text(e.start_date, e.end_date, e));
        ...
        var u = e.color ? "background:" + e.color + ";" : "",
            ...
            f = '<div event_id="' + h + '" class="' + _ + '" style="position:absolute; top:' + s + "px; left:" + t + "px; width:" + (i - 4) + "px; height:" + a + "px;" + (n || "") + '"></div>';
        l.innerHTML = f;
        var v = l.cloneNode(!0).firstChild;
        if (!o && scheduler.renderEvent(v, e, i, a, r, d)) return v;
        v = l.firstChild;
        var m = '<div class="dhx_event_move dhx_header" style=" width:' + (i - 6) + "px;" + u + '" >&nbsp;</div>';
        m += '<div class="dhx_event_move dhx_title" style="' + u + g + '">' + r + "</div>", m += '<div class="dhx_body" style=" width:' + (i - (this._quirks ? 4 : 14)) + "px; height:" + (a - (this._quirks ? 20 : 30) + 1) + "px;" + u + g + '">' + d + "</div>";
        var p = "dhx_event_resize dhx_footer";
        return o && (p = "dhx_resize_denied " + p), m += '<div class="' + p + '" style=" width:' + (i - 8) + "px;" + (o ? " margin-top:-1px;" : "") + u + g + '" ></div>', v.innerHTML = m, v
        ...
        if (e.id == this._drag_id) {
            ...
            a = scheduler._get_dnd_order(a, i, n)
        }
        var r = a * i,
        ...
        if (n) {
            ...
            var f = e.color ? "background:" + e.color + ";" : "",
                ...
                m = ["position:absolute", "top:" + i + "px", "left:" + a + "px", "width:" + (n - a - 15) + "px", v, f, e._text_style || ""].join(";"),
        ...
        if (e) {
            for (var t = scheduler._rendered, s = 0; s < t.length; s++) {
                var i = t[s];
                if (i.getAttribute("event_id") == e) return i
            }
            return null
        }
        ...
        var s = this.templates.drag_marker_class(e.start_date, e.end_date, e),
        ...
        if (e = e || this._load_url) {
            ...
            if (t = t || this._date, this._load_mode) {
                ...
                s = t;
                for (var a = !0; s < this._max_date;) s = this.date.add(s, 1, this._load_mode), this._loaded[i(t)] && a ? t = this.date.add(t, 1, this._load_mode) : a = !1;
                var n = s;
                do s = n, n = this.date.add(s, -1, this._load_mode); while (n > t && this._loaded[i(n)]);
                if (t >= s) return !1;
                for (dhtmlxAjax.get(e + "&from=" + i(t) + "&to=" + i(s), function(e) {
                        scheduler.on_load(e)
                    }); s > t;) this._loaded[i(t)] = !0, t = this.date.add(t, 1, this._load_mode)
        ...
        if (this._process && "xml" != this._process) try {
            ...
            s = !0
        } else t = this._magic_parser(e), t || (s = !0);
        s && (this.callEvent("onLoadError", [e.xmlDoc]), t = []), scheduler._process_loading(t), this.callEvent("onXLE", [])
        ...
        parse: function(e) {
            ...
            if (t.length) {
                ...
                for (var s, i = [], a = RegExp("(?:" + this.e_start + ")([^\f]*?)(?:" + this.e_end + ")", "g"); null !== (s = a.exec(t));) {
        ...
        parse_param: function(e, t) {
            var s = e.indexOf(":");
            if (-1 != s) {
                var i = e.substr(0, s).toLowerCase(),
                    a = e.substr(s + 1).replace(/\\\,/g, ",").replace(/[\r\n]+$/, "");
                "summary" == i ? i = "text" : "dtstart" == i ? (i = "start_date", a = this.parse_date(a, 0, 0)) : "dtend" == i && (i = "end_date", a = this.parse_date(a, 0, 0)), t[i] = a
            }
        },
        parse_date: function(e, t, s) {
            var i = e.split("T");
            i[1] && (t = i[1].substr(0, 2), s = i[1].substr(2, 2));
            var a = i[0].substr(0, 4),
                n = parseInt(i[0].substr(4, 2), 10) - 1,
                r = i[0].substr(6, 2);
        ...
        var a = document.getElementById(i.id),
            ...
            r = {
                ...
                setValue: function(e, t) {
                    return scheduler.form_blocks[i.type].set_value(n, e, t || {}, i)
                }
            },
        ...
        select: {
            render: function(e) {
                for (var t = (e.height || "23") + "px", s = "<div class='dhx_cal_ltext' style='height:" + t + ";'><select style='width:100%;'>", i = 0; i < e.options.length; i++) s += "<option value='" + e.options[i].key + "'>" + e.options[i].label + "</option>";
                return s += "</select></div>"
            },
            set_value: function(e, t, s, i) {
                var a = e.firstChild;
                !a._dhx_onchange && i.onchange && (a.onchange = i.onchange, a._dhx_onchange = !0), "undefined" == typeof t && (t = (a.options[0] || {}).value), a.value = t || ""
            },
            get_value: function(e) {
                return e.firstChild.value
            },
        ...
        time: {
            render: function(e) {
                ...
                var t = e.time_format,
                    ...
                    a = 1440,
                    n = 0;
                scheduler.config.limit_time_select && (a = 60 * s.last_hour + 1, n = 60 * s.first_hour, i.setHours(s.first_hour));
            ...
            set_value: function(e, t, s, i) {
                ...
                if (d.full_day) {
                    ...
                    _.checked = 0 === scheduler.date.time_part(s.start_date) && 0 === scheduler.date.time_part(s.end_date), o[l[0]].disabled = _.checked, o[l[0] + o.length / 2].disabled = _.checked, _.onclick = function() {
                        if (_.checked) {
                            var t = {};
                            scheduler.form_blocks.time.get_value(e, t, i), n = scheduler.date.date_part(t.start_date), r = scheduler.date.date_part(t.end_date), (+r == +n || +r >= +n && (0 !== s.end_date.getHours() || 0 !== s.end_date.getMinutes())) && (r = scheduler.date.add(r, 1, "day"))
                        } else n = null, r = null;
                ...
                a(o, 0, s.start_date), a(o, 4, s.end_date)
            },
            get_value: function(e, t, s) {
                var i = e.getElementsByTagName("select"),
                    a = s._time_format_order;
                if (t.start_date = new Date(i[a[3]].value, i[a[2]].value, i[a[1]].value, 0, i[a[0]].value), t.end_date = new Date(i[a[3] + 4].value, i[a[2] + 4].value, i[a[1] + 4].value, 0, i[a[0] + 4].value), !i[a[3]].value || !i[a[3] + 4].value) {
        ...
        if (e) {
            ...
            var t = window.pageYOffset || document.body.scrollTop || document.documentElement.scrollTop,
                s = window.pageXOffset || document.body.scrollLeft || document.documentElement.scrollLeft,
        ...
        for (var t = this.config.lightbox.sections, s = 0; s < t.length; s++) {
            ...
            i = i ? i.nextSibling : i;
            var a = this.form_blocks[t[s].type],
                n = a.get_value.call(this, i, e, t[s]);
            "auto" != t[s].map_to && (e[t[s].map_to] = n)
        }
        return e
        ...
        if (scheduler._dnd_start_lb) {
            ...
            var t = scheduler.getLightbox(),
                s = e && e.target ? [e.pageX, e.pageY] : [event.clientX, event.clientY];
        ...
        if (!this._lightbox) {
            ...
            for (var t = this._lightbox_template, s = this.config.buttons_left, i = 0; i < s.length; i++) t += "<div class='dhx_btn_set dhx_left_btn_set " + s[i] + "_set'><div dhx_button='1' class='" + s[i] + "'></div><div>" + scheduler.locale.labels[s[i]] + "</div></div>";
            s = this.config.buttons_right;
            for (var i = 0; i < s.length; i++) t += "<div class='dhx_btn_set dhx_right_btn_set " + s[i] + "_set' style='float:right;'><div dhx_button='1' class='" + s[i] + "'></div><div>" + scheduler.locale.labels[s[i]] + "</div></div>";
            ...
            for (var i = 0; i < a.length; i++) {
                var n = this.form_blocks[a[i].type];
                if (n) {
                    a[i].id = "area_" + this.uid();
                    var r = "";
                    a[i].button && (r = "<div class='dhx_custom_button' index='" + i + "'><div class='dhx_custom_button_" + a[i].button + "'></div><div>" + this.locale.labels["button_" + a[i].button] + "</div></div>"), this.config.wide_form && (t += "<div class='dhx_wrap_section'>");
                    var d = this.locale.labels["section_" + a[i].name];
                    "string" != typeof d && (d = a[i].name), t += "<div id='" + a[i].id + "' class='dhx_cal_lsection'>" + r + d + "</div>" + n.render.call(this, a[i]), t += "</div>"
                }
            }
        ...
        function a(e, t, s) {
            if (e && t) {
                var i = Math.abs(e.pageY - t.pageY),
        ...
        function n(e) {
            var t = scheduler.getState().drag_mode,
                s = scheduler.matrix ? scheduler.matrix[scheduler._mode] : !1,
                i = scheduler.render_view_data;
            "create" == t && s && (scheduler.render_view_data = function() {
                for (var e = scheduler.getState().drag_id, t = scheduler.getEvent(e), i = s.y_property, a = scheduler.getEvents(t.start_date, t.end_date), n = 0; n < a.length; n++) a[n][i] != t[i] && (a.splice(n, 1), n--);
        ...
        i(document.body, e[0], function(e) {
        ...
        }), i(this._els.dhx_cal_data[0], "scroll", r), i(this._els.dhx_cal_data[0], "touchcancel", r), i(this._els.dhx_cal_data[0], "contextmenu", function(e) {
            return c ? (e && e.preventDefault && e.preventDefault(), (e || event).cancelBubble = !0, !1) : void 0
        }), i(this._els.dhx_cal_data[0], e[1], function(e) {
            if (!s(e)) {
                var i;
                if (h = _ = !1, c = !0, scheduler._temp_touch_block = !0, i = o = t(e), !i) return void(_ = !0);
                var a = new Date;
                if (!_ && !h && 250 > a - g) return scheduler._click.dhx_cal_data(i), window.setTimeout(function() {
            ...
            return s(e) ? void 0 : (h || a(d, o, 200), h && (scheduler._ignore_next_click = !0), r(e), scheduler._block_next_stop ? (scheduler._block_next_stop = !1, e.preventDefault && e.preventDefault(), e.cancelBubble = !0, !1) : void 0)
        ...
        e._methods = ["_set_event_text_style", "", "changeEventId", "_dp_hook_delete"], this._dp_hook_delete = function(e) {
            ...
            var t = this.obj.getEvent(e),
                s = {};
            for (var i in t) 0 !== i.indexOf("_") && (s[i] = t[i] && t[i].getUTCFullYear ? this.obj.templates.xml_format(t[i]) : t[i]);
            return s
        ...
        var i = 0;
        if (!scheduler.skin || "classic" !== scheduler.skin && "glossy" !== scheduler.skin || (i = 1), this._configure(scheduler.config, scheduler._skin_settings, i), this._configure(scheduler.xy, scheduler._skin_xy, i), "flat" === scheduler.skin && (scheduler.xy.scale_height = 35, scheduler.templates.hour_scale = function(e) {
                var t = e.getMinutes();
                t = 10 > t ? "0" + t : t;
                ...
                if (scheduler.templates.month_day = function(s) {
                    ...
                    for (var s = scheduler._els.dhx_cal_navline[0].getElementsByTagName("div"), i = null, a = 211, n = 0; n < s.length; n++) {
                        ...
                        if (d) switch (r.style.right = "auto", d) {
                            case "day_tab":
                                r.style.left = "12px", r.className += " dhx_cal_tab_first";
                                break;
                            case "week_tab":
                                r.style.left = "75px";
                                break;
                            case "month_tab":
                                r.style.left = "138px", r.className += " dhx_cal_tab_last";
                                break;
                            default:
    ...
    function() {
        function e(e, t, s) {
            t && (e._date = t), s && (e._mode = s)
        }
        var t = scheduler.setCurrentView,
            s = scheduler.updateView,
            i = null,
            a = null,
            n = function(t, n) {
                var r = this;
                window.clearTimeout(a), window.clearTimeout(i), e(this, t, n), a = setTimeout(function() {
            ...
            r = function(t, n) {
                var r = this,
                    d = arguments;
                e(this, t, n), window.clearTimeout(i), i = setTimeout(function() {
                    a || s.apply(r, d)
                }, scheduler.config.delay_render)
            };
