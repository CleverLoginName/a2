...
<div class="site_container">
    <div class="wr_footer w_1800" id="inner">
        <div class="footer">
            <table width="100%" border="0" class="tbl_authorise f_18">
                ...
                <tr>
                    ...
                    <td scope="col" align="left"><span class="bld">Job No:</span>213421 HAYWARD<br><span class="bld">Consultant:</span> David Mitchell
                    </td>
                    <td scope="col" align="left"><span class="bld">Print Date:</span> 04 Feb 2017<br><span class="bld">Page No:</span>	7-20</td>
                </tr>
                </tbody>
            </table>
