            ...
            <div class="col-xs -12 col-sm- 12 col-md-12 col-lg-12 content_left">
                ...
                <div class="form_container">
                        <form  files="true" class="form-horizontal" role="form" method="post" id="new-prod-form"
                               enctype="multipart/form-data" novalidate="novalidate" action="{!! url('/products/composite-products/edit') !!}">
                        ...
                        <div class="form-group">
                                    ...
                                    <section class="col-md-12" style="max-height: 150px; overflow-y: auto">
                                        ...
                                        <select class="image-picker show-html" id="symbol"
                                            ...
                                            @foreach($icons as $symbol)
                                                @if($symbol->id == $product->icon)
                                                <option data-img-src="{!! $symbol->path !!}" value="{!! $symbol->id !!}" selected="selected">{!! $symbol->name !!}</option>
                                                @else
                            ...
                            <div class="row form-group @if ($errors->has('image')) has-error @endif">
                                ...
                                <div class="row form-group @if ($errors->has('manufacturing_product_code')) has-error @endif">
                                    ...
                                    <div class="col-md-7">
                                        {!! Form::text('manufacturing_product_code', $product->manufacturing_product_code,['id'=>'manufacturing_product_code','class'=>"form-control"]) !!}
                                ...
                                <div class="row form-group @if ($errors->has('builder_code')) has-error @endif">
                                    ...
                                    <div class="col-md-7">
                                        {!! Form::text('builder_code', $product->builder_code,['id'=>'builder_code','class'=>"form-control"]) !!}
                                ...
                                <div class="row form-group @if ($errors->has('pronto_code')) has-error @endif">
                                    ...
                                    <div class="col-md-7">
                                        {!! Form::text('pronto_code', $product->pronto_code,['id'=>'pronto_code','class'=>"form-control"]) !!}
                                ...
                                <div class="row form-group @if ($errors->has('builder_price')) has-error @endif">
                                    ...
                                    <div class="col-md-7">
                                        {!! Form::text('builder_price', $product->builder_price,['id'=>'builder_price','class'=>"form-control"]) !!}
                                ...
                                <div class="row form-group @if ($errors->has('supplier_price')) has-error @endif">
                                    ...
                                    <div class="col-md-7">
                                        {!! Form::text('supplier_price', $product->supplier_price,['id'=>'supplier_price','class'=>"form-control"]) !!}
                                ...
                                <div class="row form-group @if ($errors->has('contractor_price')) has-error @endif">
                                    ...
                                    <div class="col-md-7">
                                        {!! Form::text('contractor_price',  $product->contractor_price,['id'=>'contractor_price','class'=>"form-control"]) !!}
                                ...
                                <div class="row form-group @if ($errors->has('discount')) has-error @endif">
                                    ...
                                    <div class="col-md-7">
                                        {!! Form::text('discount', $product->discount ,['id'=>'discount','class'=>"form-control"]) !!}
...
@section('post-js')
    ...
    <script>
        ...
        $("#symbol").imagepicker({selected:{!! $product->icon !!}});
