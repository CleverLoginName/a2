            ...
            <div class="form_container">
                <form class="form-horizontal">
                    ...
                    <div class="wr_btn clearfix">
                        <a href="{!! url('/products/packs/done') !!}" name="Save"  style="color: white" type="button" class="btn_save" id="Save" value="Done" >Done</a>
                    </div>
                    <!-- -------- Buttons End ---------- -->
...
<script>
    ...
    $(function() {
        ...
        dragula([document.getElementById('left-events'), document.getElementById('right-events')], {
            ...
            $.post( "/products/packs/selected", { child: el.id,parent:x } );
        }).on('remove', function (el) {
            //console.log(el.id);
            var x = el.getAttribute("parent_id");
            $.post( "/products/packs/remove", { child: el.id,parent:x } );
        });
