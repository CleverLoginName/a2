            ...
            <div class="col-xs -12 col-sm- 12 col-md-12 col-lg-12 content_left">
                ...
                <div class="form_container">
                    <form  files="true" class="form-horizontal" role="form" method="post" id="new-prod-form"
                           enctype="multipart/form-data" novalidate="novalidate" action="{!! url('/products/packs/edit') !!}">
                        ...
                        <div class="row form-group @if ($errors->has('name')) has-error @endif">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('name', $pack->name,['id'=>'name','class'=>"form-control"]) !!}
                        ...
                        <div class="row form-group @if ($errors->has('description')) has-error @endif">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('description', $pack->description,['id'=>'description','class'=>"form-control"]) !!}
                        ...
                        <div class="row form-group @if ($errors->has('builder_price')) has-error @endif">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('builder_price', $pack->builder_price,['id'=>'builder_price','class'=>"form-control"]) !!}
                        ...
                        <div class="row form-group @if ($errors->has('supplier_price')) has-error @endif">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('supplier_price', $pack->supplier_price,['id'=>'supplier_price','class'=>"form-control"]) !!}
                        ...
                        <div class="row form-group @if ($errors->has('contractor_price')) has-error @endif">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('contractor_price', $pack->contractor_price,['id'=>'contractor_price','class'=>"form-control"]) !!}
